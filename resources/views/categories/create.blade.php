...
@section('title', 'Tambah Kategori - PT. Maju Jaya Konstruksi')
...
<section class="py-16">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('categories.store') }}" class="bg-white rounded-lg shadow-md p-8">
            @csrf
            ...
            <div class="mb-6">
                <label for="slug" class="block text-gray-700 font-semibold mb-2">Slug (otomatis dari nama jika kosong)</label>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('categories.index') }}" class="bg-gray-300 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-400 transition font-semibold">
                    Batal
                </a>
            </div>
        </form>
